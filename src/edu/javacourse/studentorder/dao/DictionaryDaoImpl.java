...
public class DictionaryDaoImpl implements DictionaryDao {
    ...
    //TODO refactoring - make on method
    ...
    @Override
    public List<PassportOffice> findPassportOffices(String areaId) throws Exception {
    ...
    @Override
    public List<RegisterOffice> findRegisterOffices(String areaId) throws Exception {
    ...
    @Override
    public List<CountryArea> findAreas(String areaId) throws Exception {
